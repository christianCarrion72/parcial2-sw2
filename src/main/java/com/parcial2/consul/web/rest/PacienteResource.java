...
/**
 * REST controller for managing {@link com.parcial2.consul.domain.Paciente}.
 */
@RestController
...
public class PacienteResource {
    ...
    public ResponseEntity<List<PacienteDTO>> getAllPacientes(
        ...
        Page<PacienteDTO> page;
        if (eagerload) {
            page = pacienteService.findAllWithEagerRelationships(pageable);
        } else {
            page = pacienteService.findAll(pageable);
        }
