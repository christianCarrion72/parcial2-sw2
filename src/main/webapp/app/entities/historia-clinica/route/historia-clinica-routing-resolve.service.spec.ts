...
import historiaClinicaResolve from './historia-clinica-routing-resolve.service';

describe('HistoriaClinica routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: HistoriaClinicaService;
  let resultHistoriaClinica: IHistoriaClinica | null | undefined;
  ...
  describe('resolve', () => {
    it('should return IHistoriaClinica returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        historiaClinicaResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
      ...
      expect(resultHistoriaClinica).toEqual({ id: 123 });
    });
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultHistoriaClinica).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IHistoriaClinica>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
