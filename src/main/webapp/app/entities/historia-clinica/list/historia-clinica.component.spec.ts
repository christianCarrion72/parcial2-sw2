...
import { sampleWithRequiredData } from '../historia-clinica.test-samples';
...
describe('HistoriaClinica Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.historiaClinicas()[0]).toEqual(expect.objectContaining({ id: 20252 }));
  });

  describe('trackId', () => {
    it('should forward to historiaClinicaService', () => {
      const entity = { id: 20252 };
      jest.spyOn(service, 'getHistoriaClinicaIdentifier');
      const id = comp.trackId(entity);
      expect(service.getHistoriaClinicaIdentifier).toHaveBeenCalledWith(entity);
