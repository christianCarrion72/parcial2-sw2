...
type MedicoFormDefaults = Pick<NewMedico, 'id' | 'especialidades'>;

type MedicoFormGroupContent = {
  id: FormControl<IMedico['id'] | NewMedico['id']>;
  matricula: FormControl<IMedico['matricula']>;
  user: FormControl<IMedico['user']>;
  especialidades: FormControl<IMedico['especialidades']>;
};
...
export class MedicoFormService {
  createMedicoFormGroup(medico: MedicoFormGroupInput = { id: null }): MedicoFormGroup {
    ...
    return new FormGroup<MedicoFormGroupContent>({
      ...
      matricula: new FormControl(medicoRawValue.matricula, {
        validators: [Validators.required],
      }),
      user: new FormControl(medicoRawValue.user),
      especialidades: new FormControl(medicoRawValue.especialidades ?? []),
    });
  }
